...
const data: {
...
}[] = [
	{
		...
		color: String(import.meta.env.VITE_API_SUCCESS_COLOR),
		stock: 380,
		price: 14.5,
		store: 'Company A',
		file: 'Figma',
	...
	},
	{
		...
		color: String(import.meta.env.VITE_API_WARNING_COLOR),
		stock: 27,
		price: 12.8,
		store: 'Company D',
		file: 'XD',
	},
	{
		...
		color: String(import.meta.env.VITE_API_DANGER_COLOR),
		stock: 219,
		price: 16,
		store: 'Company C',
		file: 'Sketch',
