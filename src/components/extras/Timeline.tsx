...
// New TimelineItemRight component
export const TimelineItemRight = forwardRef<HTMLDivElement, ITimelineItemProps>(
	({ className, color, label, children, ...props }, ref) => {
		return (
			<div ref={ref} className={classNames('timeline-item', className)} {...props}>
...
TimelineItemRight.displayName = 'TimelineItemRight';
