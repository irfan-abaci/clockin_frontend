	...
	return (
		...
		<div className={classNames('apex-chart', className)} {...props}>
			<ReactApexChart
				options={{
					colors: [
						import.meta.env.VITE_API_PRIMARY_COLOR,
						import.meta.env.VITE_API_SECONDARY_COLOR,
						import.meta.env.VITE_API_SUCCESS_COLOR,
						import.meta.env.VITE_API_INFO_COLOR,
						import.meta.env.VITE_API_WARNING_COLOR,
						import.meta.env.VITE_API_DANGER_COLOR,
					],
					plotOptions: {
						candlestick: {
							colors: {
								upward: import.meta.env.VITE_API_SUCCESS_COLOR,
								downward: import.meta.env.VITE_API_DANGER_COLOR,
							},
						},
						boxPlot: {
							colors: {
								upper: import.meta.env.VITE_API_SUCCESS_COLOR,
								lower: import.meta.env.VITE_API_DANGER_COLOR,
							},
						},
					},
					...options,
