...
export const demoPagesMenu = {
	...
	appointment: {
		...
		icon: 'Today',
		subMenu: {
			dashboard: dashboardDemo.dashboardBooking,
			calendar: {
				id: 'calendar',
				text: 'Calendar',
...
export const helpCenterRoutes = {
	Sites: {
		id: 'site',
		text: 'Site',
		path: '/helpcenter/groupvisibility',
		icon: 'Apartment',
		subMenu: {
			GroupVibility: {
				id: 'data_fields',
	...
	settings: {
		...
		subMenu: {
			...
			messages: {
				id: 'messages_helpcenter',
				text: 'Messages',
				path: '/helpcenter/messages',
				icon: 'Message',
			},
