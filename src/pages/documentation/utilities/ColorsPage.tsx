...
<p className='text-white-50 bg-dark'>.text-white-50</p>`;
	...
	const VARIABLES = `
$primary:       ${import.meta.env.VITE_API_PRIMARY_COLOR};
$secondary:		${import.meta.env.VITE_API_SECONDARY_COLOR};
$success:       ${import.meta.env.VITE_API_SUCCESS_COLOR};
$info:          ${import.meta.env.VITE_API_INFO_COLOR};
$warning:       ${import.meta.env.VITE_API_WARNING_COLOR};
$danger:        ${import.meta.env.VITE_API_DANGER_COLOR};
$light:         ${import.meta.env.VITE_API_LIGHT_COLOR};
$dark:          ${import.meta.env.VITE_API_DARK_COLOR};`;
	const VARIABLES_2 = `
