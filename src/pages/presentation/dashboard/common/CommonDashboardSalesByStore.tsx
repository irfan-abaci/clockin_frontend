		...
		yaxis: [
			{
				...
				axisBorder: {
					show: true,
					color: import.meta.env.VITE_API_INFO_COLOR,
				},
				labels: {
					style: {
						colors: import.meta.env.VITE_API_INFO_COLOR,
					},
				},
				title: {
			...
			},
			{
				...
				axisBorder: {
					show: true,
					color: import.meta.env.VITE_API_SUCCESS_COLOR,
				},
				labels: {
					style: {
						colors: import.meta.env.VITE_API_SUCCESS_COLOR,
					},
				},
				title: {
			...
			},
			{
				...
				axisBorder: {
					show: true,
					color: import.meta.env.VITE_API_WARNING_COLOR,
				},
				labels: {
					style: {
						colors: import.meta.env.VITE_API_WARNING_COLOR,
					},
				},
				title: {
