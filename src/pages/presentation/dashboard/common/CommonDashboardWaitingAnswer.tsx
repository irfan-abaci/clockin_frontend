...
const AnswerCustomer: FC<IAnswerCustomerProps> = (props: IAnswerCustomerProps) => {
	...
	const [state] = useState<IChartOptions>({
		...
		options: {
			...
			colors: [
				(color === 'primary' && import.meta.env.VITE_API_PRIMARY_COLOR) ||
					(color === 'secondary' && import.meta.env.VITE_API_SECONDARY_COLOR) ||
					(color === 'success' && import.meta.env.VITE_API_SUCCESS_COLOR) ||
					(color === 'info' && import.meta.env.VITE_API_INFO_COLOR) ||
					(color === 'warning' && import.meta.env.VITE_API_WARNING_COLOR) ||
					(color === 'danger' && import.meta.env.VITE_API_DANGER_COLOR),
			],
		},
	});
	return (
